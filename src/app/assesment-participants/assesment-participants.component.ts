...
@Component({
    selector: 'app-assesment-participants',
    templateUrl: './assesment-participants.component.html',
    styleUrls: ['./assesment-participants.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class AssesmentParticipantsListComponent implements OnInit {
    ...
    getList() {
        ...
        this._service.get('project-student-list-by-project-id/' + this.projectId).subscribe(res => {
