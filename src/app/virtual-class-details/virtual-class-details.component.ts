...
@Component({
    selector: 'app-virtual-class-details',
    templateUrl: './virtual-class-details.component.html',
    styleUrls: ['./virtual-class-details.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class VirtualClassDetailsComponent implements OnInit {
