...
@Component({
    selector: 'app-show-assesment-list',
    templateUrl: './show-assesment-list.component.html',
    styleUrls: ['./show-assesment-list.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class ShowAssesmentListComponent implements OnInit {
    ...
    getList() {
        ...
        this._service.get('getProjectList').subscribe(res => {
            res.forEach(element => {
                if(this.assesmentId == element.id){
                    this.projectName = element.name;
                    this.assesmentList = element.assesments;
                    this.is_loaded = true;
                }
            });
