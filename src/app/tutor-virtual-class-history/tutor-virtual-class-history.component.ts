...
@Component({
    selector: 'app-tutor-virtual-class-history',
    templateUrl: './tutor-virtual-class-history.component.html',
    styleUrls: ['./tutor-virtual-class-history.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class TutorVirtualClassHistoryComponent implements OnInit {
    ...
    SearchTutor(){
        ...
        this._service.post('getMeetingsByTutorWithDateByProjectId/2', params).subscribe(res => {
