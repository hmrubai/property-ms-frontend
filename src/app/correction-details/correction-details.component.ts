...
@Component({
    ...
    styleUrls: ['./correction-details.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class CorrectionDetailsComponent implements OnInit {
    ...
    getDetails(){
        ...
        this._service.get('get-written-practise-paragraph-details/'+ this.correctionId).subscribe(res => {
            this.blockUI.stop();
            this.correctionDetails = res;
            this.is_loaded = true;
            this.blockUI.stop();
        }, err => {
