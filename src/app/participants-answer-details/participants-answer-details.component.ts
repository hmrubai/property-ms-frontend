...
@Component({
    selector: 'app-participants-answer-details',
    templateUrl: './participants-answer-details.component.html',
    styleUrls: ['./participants-answer-details.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class ParticipantAnswerDetailsComponent implements OnInit {
    ...
    constructor(
        ...
        this.page.size = 10;
        this.participantId = this.route.snapshot.paramMap.get("studentId");
    ...
    getList() {
        ...
        this._service.get('get-student-history-with-written/' + this.participantId + '/' + this.examId).subscribe(res => {
