...
@Component({
    selector: 'app-student-virtual-class-history',
    templateUrl: './student-virtual-class-history.component.html',
    styleUrls: ['./student-virtual-class-history.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class StudentVirtualClassHistoryComponent implements OnInit {
