...
@Component({
    selector: 'app-beat-corrector-list',
    templateUrl: './beat-corrector-list.component.html',
    styleUrls: ['./beat-corrector-list.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class BEATCorrectorListComponent implements OnInit {
    ...
    getList() {
        ...
        this._service.get('admin/beat/corrector-list').subscribe(res => {
            // if (!res.status) {
            //     this.toastr.error(res.message, 'Error!', { closeButton: true, disableTimeOut: true });
            //     return;
            // }
            this.correctorList = res;
