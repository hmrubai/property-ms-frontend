...
@Component({
    selector: 'app-beat-collaborator-list',
    templateUrl: './beat-collaborator-list.component.html',
    styleUrls: ['./beat-collaborator-list.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class  BEATCollaboratorPaymentListComponent implements OnInit {
    ...
    public export() {
        ...
        this._service.get('admin/beat/transaction/list-with-promo-export', params).subscribe(res => {
            if (res.result.length > 0) {
                ...
                res.result.forEach(element => {
                    readyToExport.push({
                        ...
                        paid: element.paid_amount,
                        discount: element.discount,
                        payment_method: element.card_type,
                ...
                XLSX.utils.book_append_sheet(workBook, workSheet, 'Collaboration List'); // add the worksheet to the book
                XLSX.writeFile(workBook, 'Collaboration Report.xlsx'); // initiate a file download in browser
