...
@Component({
    selector: 'app-beat-correction-summary',
    templateUrl: './beat-correction-summary.component.html',
    styleUrls: ['./beat-correction-summary.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class BEATCorrectionSummaryComponent implements OnInit {
    ...
    getList() {
        this.blockUI.start();
        this._service.get('admin/beat/mini-dashboard-info').subscribe(res => {
            this.blockUI.stop();
            // if (!res.status) {
