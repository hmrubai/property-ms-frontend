...
@Component({
    selector: 'app-external-virtual-class-history',
    templateUrl: './external-virtual-class-history.component.html',
    styleUrls: ['./external-virtual-class-history.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class ExternalVirtualClassHistoryComponent implements OnInit {
    ...
    SearchTutor(){
        ...
        this._service.post('getMeetingsByDate', params).subscribe(res => {
