...
@Component({
    selector: 'app-tutor-external-virtual-class-history',
    templateUrl: './tutor-external-virtual-class-history.component.html',
    styleUrls: ['./tutor-external-virtual-class-history.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class TutorExternaVirtualClassHistoryComponent implements OnInit {
    ...
    SearchTutor(){
        ...
        this._service.post('getMeetingsByTutorWithDate', params).subscribe(res => {
