...
@Component({
    selector: 'app-correction-summary',
    templateUrl: './correction-summary.component.html',
    styleUrls: ['./correction-summary.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class CorrectionSummaryComponent implements OnInit {
