...
@Component({
    selector: 'app-guardian-complain-ticket',
    templateUrl: './guardian-complain-ticket.component.html',
    styleUrls: ['./guardian-complain-ticket.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class GuardianComplainTicketComponent implements OnInit {
    ...
    getList() {
        ...
        this._service.get('get-ticket-list').subscribe(res => {
            this.ticketList = res;
            ...
            .subscribe(
                result => {
                    if (result) {
                        ...
                        this._service.post('save-ticket-as-solved', params).subscribe(res => {
        ...
        this.confirmService.confirm('Are you sure?', 'Do you want to delete?')
            .subscribe(
                result => {
                    if (result) {
                        this.blockUI.start('Updating...');
                        this._service.get('delete-solved-ticket').subscribe(res => {
                            this.toastr.success(res.message, 'Successful!');
                            this.getList();
                            this.blockUI.stop();
                        }, err => {
