...
export class CorrectionListComponent implements OnInit {
    ...
    courseList = [];
    instructorList = [];
    statusList = [{ id: 0, name: 'Assigned' }, { id: 1, name: 'Answered' }, { id: 4, name: 'Completed' }, { id: null, name: 'All' }]
    correctionList = [];
    studentList = [];
    selectedStudentIds = [];
    selectedStudentList = [];
    ...
    typeList = [
        ...
        { id: 'essay', name: 'Essay' },
        { id: 'translation-english-to-bangla', name: 'English to Bangla' },
        { id: 'translation-bangla-to-english', name: 'Bangla to English' },
        { id: 'precise', name: 'Precise' },
        { id: 'explanation', name: 'Explanation' },
        { id: 'short-question', name: 'Short Question' },
        { id: 'creative-question', name: 'Creative Question' },
        { id: 'sentence-making', name: 'Sentence Making' },
        { id: 'gap-filling-with-clue', name: 'Gap filling with clue' },
        { id: 'gap-filling-without-clue', name: 'Gap filling without clue' },
        { id: 'report-writing', name: 'Report Writing' },
        { id: 'email-writing', name: 'Email Writing' },
        { id: 'application-writing', name: 'Application Writing' },
    ];
