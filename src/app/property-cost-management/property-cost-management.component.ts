...
@Component({
    selector: 'app-property-cost-management',
    templateUrl: './property-cost-management.component.html',
    styleUrls: ['./property-cost-management.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class  PropertyCostManagementComponent implements OnInit {
    ...
    propertyList = [
        {
            ...
            image: "property1.jpg",
            cost: {
                operation_expense: 150000,
                water_expense: 75000,
                heating_expanse: 35000
            }
        },
        {
            id: 2,
            ...
            image: "property2.jpg",
            cost: {
                operation_expense: 100000,
                water_expense: 80000,
                heating_expanse: 45000
            }
        }
    ];
    ...
    changeProperty(property_id)
    {
        this.is_loaded = false;
        this.propertyList.forEach(element => {
            if(element.id == this.propertyID){
                this.property_cost_details = null;
                this.property_cost_details = {
                    operation: element.cost.operation_expense,
                    water: element.cost.water_expense,
                    heating: element.cost.heating_expanse
                };
                this.is_loaded = true;
            }
         });
