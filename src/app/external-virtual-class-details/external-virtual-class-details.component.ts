...
@Component({
    selector: 'app-external-virtual-class-details',
    templateUrl: './external-virtual-class-details.component.html',
    styleUrls: ['./external-virtual-class-details.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class ExternalVirtualClassDetailsComponent implements OnInit {
    ...
    getDetails(){
        ...
        this._service.get('zoom-meeting/' + this.detailsId).subscribe(res => {
            this.historyDetails = res.participants;
            this.history = res;
            this.tutorDetails = res.tutor;
            this.participantDetails = res.participants[0].student;
