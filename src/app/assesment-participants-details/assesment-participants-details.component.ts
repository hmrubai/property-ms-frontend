...
@Component({
    selector: 'app-assesment-participants-details',
    templateUrl: './assesment-participants-details.component.html',
    styleUrls: ['./assesment-participants-details.component.css'],
...
export class ParticipantDetailsComponent implements OnInit {
    ...
    getList() {
        ...
        this._service.get('getAssessmentExamListByStudentIdForAdmin/' + this.participantId).subscribe(res => {
            this.participantDetails = res.student;
            this.projectDetails = res.projects;
            this.is_loaded = true;
