...
@Component({
    selector: 'app-beat-payment-list',
    templateUrl: './beat-payment-list.component.html',
    styleUrls: ['./beat-payment-list.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class  BEATPaymentListComponent implements OnInit {
            ...
            if (res.result.length > 0) {
                ...
                res.result.forEach(element => {
                    readyToExport.push({
                        ...
                        payment_date: element.created_at,
                    })
                });
                ...
                XLSX.utils.book_append_sheet(workBook, workSheet, 'Payment List'); // add the worksheet to the book
                XLSX.writeFile(workBook, 'Payment Report.xlsx'); // initiate a file download in browser
