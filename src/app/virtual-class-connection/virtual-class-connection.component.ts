...
@Component({
    selector: 'app-virtual-class-connection',
    templateUrl: './virtual-class-connection.component.html',
    styleUrls: ['./virtual-class-connection.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class VirtualClassConnectionComponent implements OnInit {
